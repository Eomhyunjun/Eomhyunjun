...
|     | pipex | `pipe`  `redirection` | https://github.com/Eomhyunjun/pipex | [![HEOM's 42Project Score](https://badge42.herokuapp.com/api/project/heom/pipex)](https://github.com/JaeSeoKim/badge42)
...
|     | mini_shell | `clone` `bash` `pipe`  `redirection` `signal` | https://github.com/Eomhyunjun/minishell | [![HEOM's 42Project Score](https://badge42.herokuapp.com/api/project/heom/minishell)](https://github.com/JaeSeoKim/badge42)
